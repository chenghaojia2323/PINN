...
if __name__ == "__main__": 
    ...
    # Load Data
    data = scipy.io.loadmat(r'H:\.Workspace\22_SUMMER\PINNs-master\main\Data/cylinder_nektar_wake.mat')
    ...
    error_lambda_1 = np.abs(lambda_1_value - 1.0)*100 # lambda_1 = 1
    error_lambda_2 = np.abs(lambda_2_value - 0.01)/0.01 * 100 # lambda_2 = 0.01
